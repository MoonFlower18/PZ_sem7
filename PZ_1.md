...
personal  
preference, but it’s good habit to include a space on either side of
the  
assignment operator.
...
the three elements in z by 2. Then it added 100 | to each element to get
...
> my_div \<- z div my_sqrt Error: unexpected symbol in “my_div \<- z
> div” my_div \<- z / my_sqrt
...
|================================================== | 74% | When we did
z \* 2 + 100 in our earlier example, z was a vector of length 3, | but
...
|================================================================== |
97% | You can type the first two letters of the variable name, then hit
